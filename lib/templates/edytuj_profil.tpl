{*
      Szablon formularza: Edycja profilu
     
      @package edytuj_profil.tpl
...
{/if}
    ...
    <fieldset>
		...
		<input type="hidden" name="poprzedni_email" value="{$dane.poprzedni_email}" />
		<input type="hidden" name="login" value="{$dane.login}" />
        <div>
            <label for="login">Login użytkownika: {$dane.login} </label>
        </div>
		...
		<div>
            ...
            <input type="text" id="imie" name="imie" size="20" maxlength="45" value="{if isset($dane.imie)}
																							{$dane.imie}{/if}" />
        </div>
		...
		<div>
            ...
            <input type="text" id="login" name="nazwisko" size="20" maxlength="20" value="{if isset($dane.nazwisko)}
																								{$dane.nazwisko}{/if}" />
        </div>
